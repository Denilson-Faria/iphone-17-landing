        ...
        <footer className="bg-gray 900 border-t border-y-gray-800">
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-md text-gray-300 mt-6 text-center">Copyright © 2025 Apple Inc. Todos os direitos reservados.</p>
                ...
                <p className="text-xs text-gray-500 mt-6">Site criado para fins de estudo em React + Tailwind CSS</p>
            </div>
